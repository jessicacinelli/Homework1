...
tcount.R62-M0-N0 <- read.delim("ffdatools/counts/tcount-R62-M0-N0.txt")
CWIN<-tcount.bglsep$CWIN
COUNT<-tcount.bglsep$COUNT

tcount.R62-M0-N4 <- read.delim("ffdatools/counts/tcount-R62-M0-N4.txt")
tcount.R62-M0-NC <- read.delim("ffdatools/counts/tcount-R62-M0-NC.txt")
